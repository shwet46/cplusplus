...
function Tuthero() {
  return (
    <div className="flex flex-col justify-center items-center h-screen gap-4 px-6 md:px-12 lg:px-24 transition-all duration-300 ease-in-out text-center">
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-cyan-700 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-white hover:text-transparent hover:bg-clip-text transition-all duration-800 ease-in-out">
